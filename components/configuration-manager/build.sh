#!/usr/bin/env bash
# Build the NT Configuration Manager component and stage it as the kernel's rootserver
...
echo "ntos-configuration-manager staged: rust-micro/.tmp/rootserver.elf"
