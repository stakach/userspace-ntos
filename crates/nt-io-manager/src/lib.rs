...
pub use pipe::{
    ...
    PipeInformation, PipeNameWaiter, PipeNameWaiterTable, PipeParams, PipeRegistry,
    PipeServerAvailability, PipeServerAvailabilityTable, PipeState, PipeWaitRequest, PipeWaiter,
