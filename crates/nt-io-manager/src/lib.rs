...
pub use pipe::{
    ...
    PipeNameWaiter, PipeNameWaiterTable, PipeParams, PipeRegistry, PipeServerAvailability,
    PipeServerAvailabilityTable, PipeState, PipeWaitRequest, PipeWaiter, PipeWaiterTable,
