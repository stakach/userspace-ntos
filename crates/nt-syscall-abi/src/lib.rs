...
pub const NT_SYSCALLS: &[NtSyscall] = &[
    ...
    n("NtCreateTimer", 56),
    n("NtCreateToken", 57),
    n("NtDebugActiveProcess", 59),
    n("NtDebugContinue", 60),
    ...
    n("NtImpersonateClientOfPort", 94),
    ...
    n("NtQueryQuotaInformationFile", 174),
    ...
    n("NtSetQuotaInformationFile", 245),
...
pub const ZW_ALIASES: &[ZwAlias] = &[
    ...
    z("ZwContinue", "NtContinue", 34),
    z("ZwCreateDebugObject", "NtCreateDebugObject", 35),
    ...
    z("ZwDebugActiveProcess", "NtDebugActiveProcess", 59),
    z("ZwDebugContinue", "NtDebugContinue", 60),
    ...
    z("ZwImpersonateClientOfPort", "NtImpersonateClientOfPort", 94),
    ...
    z("ZwLoadKey2", "NtLoadKey2", 103),
    z("ZwLoadKeyEx", "NtLoadKeyEx", 104),
    ...
    z("ZwQueryMutant", "NtQueryMutant", 169),
    ...
    z("ZwQueryTimer", "NtQueryTimer", 183),
    ...
    z("ZwRaiseException", "NtRaiseException", 189),
    ...
    z("ZwRemoveProcessDebug", "NtRemoveProcessDebug", 199),
    ...
    z("ZwUnloadKey2", "NtUnloadKey2", 273),
    z("ZwUnloadKeyEx", "NtUnloadKeyEx", 274),
    ...
    z("ZwWaitForDebugEvent", "NtWaitForDebugEvent", 279),
