...
pub use reactos_registration::{
    ...
    seed_reactos_explorer_shell_com_classes_into_target, seed_reactos_print_setup_in_mutable_hives,
    ...
    ReactOsSetupSeedTarget, CLSID_REBAR_BAND_SITE, CLSID_START_MENU,
