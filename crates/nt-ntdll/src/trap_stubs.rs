...
generate_trap_stubs! {
    ...
    (nt_continue, "NtContinue", 34),
    (nt_create_debug_object, "NtCreateDebugObject", 35),
    ...
    (nt_create_process, "NtCreateProcess", 49),
    ...
    (nt_debug_active_process, "NtDebugActiveProcess", 59),
    (nt_debug_continue, "NtDebugContinue", 60),
    ...
    (nt_load_key2, "NtLoadKey2", 103),
    (nt_load_key_ex, "NtLoadKeyEx", 104),
    ...
    (nt_open_process_token_ex, "NtOpenProcessTokenEx", 130),
    ...
    (nt_open_thread_token_ex, "NtOpenThreadTokenEx", 136),
    ...
    (nt_query_quota_information_file, "NtQueryQuotaInformationFile", 174),
    ...
    (nt_raise_exception, "NtRaiseException", 189),
    ...
    (nt_remove_process_debug, "NtRemoveProcessDebug", 199),
    ...
    (nt_set_quota_information_file, "NtSetQuotaInformationFile", 245),
    ...
    (nt_test_alert, "NtTestAlert", 268),
    (nt_unload_driver, "NtUnloadDriver", 271),
    (nt_unload_key, "NtUnloadKey", 272),
    (nt_unload_key2, "NtUnloadKey2", 273),
    (nt_unload_key_ex, "NtUnloadKeyEx", 274),
    ...
    (nt_wait_for_debug_event, "NtWaitForDebugEvent", 279),
