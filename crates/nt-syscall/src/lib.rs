...
impl NativeService {
    ...
    pub const ALL: &'static [NativeService] = &[
        ...
        NativeService::NtSaveKeyEx,
        NativeService::NtCancelIoFile,
        NativeService::NtLockFile,
        NativeService::NtUnlockFile,
