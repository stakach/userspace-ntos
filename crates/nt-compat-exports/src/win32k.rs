...
pub const WIN32K_NTOSKRNL: &[ExportDescriptor] = &[
    ...
    // --- Ob ---
    e("ObfReferenceObject", Partial, "typed USER/Event/LPC references plus brokered EPROCESS/ETHREAD pointer references"),
    ...
    e("ObfDereferenceObject", Partial, "typed USER/Event/LPC releases plus brokered EPROCESS/ETHREAD pointer releases"),
    // --- Ps ---
    ...
    e("PsGetProcessExitStatus", Partial, "live EPROCESS state queried through the executive Ps broker and nt-process"),
    ...
    e("PsGetCurrentProcessSessionId", Partial, "live current EPROCESS session queried through the executive Ps broker"),
    e("PsLookupThreadByThreadId", Partial, "CID lookup acquires a deletion-blocking ETHREAD pointer reference through the Ps broker"),
    e("PsGetThreadId", Partial, "process/thread identity + state queries routed to nt-process"),
    e("PsLookupProcessByProcessId", Partial, "CID lookup acquires a deletion-blocking EPROCESS pointer reference through the Ps broker"),
    ...
    e("PsGetProcessExitProcessCalled", Partial, "live EPROCESS exit state queried through the executive Ps broker"),
    ...
    e("PsIsThreadTerminating", Partial, "live ETHREAD termination state queried through the executive Ps broker"),
    e("PsReferencePrimaryToken", Partial, "token references routed to nt-security's token store"),
    e("PsGetThreadFreezeCount", Partial, "live ETHREAD freeze state queried through the executive Ps broker"),
    e("PsIsSystemThread", Partial, "live ETHREAD system-thread identity queried through the executive Ps broker"),
    ...
    e("RtlImageNtHeader", Partial, "checked PE32+ header parsing over registered mapped-image extents in nt-pe-loader"),
