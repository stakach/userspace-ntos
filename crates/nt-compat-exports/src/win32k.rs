...
pub const WIN32K_NTOSKRNL: &[ExportDescriptor] = &[
    ...
    e("MmUnsecureVirtualMemory", Implemented, "releases an exact process-owned executive MM security lease"),
    e("MmSecureVirtualMemory", Implemented, "validates one committed VAD and returns an opaque executive MM security lease"),
    ...
    e("PsReferencePrimaryToken", Partial, "primary-token projection acquires a checked pointer reference and retains its canonical EPROCESS owner"),
    ...
    e("ZwEnumerateValueKey", Partial, "enumerates leased SYSTEM values in CM order with all native value-information layouts; non-SYSTEM dynamic keys remain"),
