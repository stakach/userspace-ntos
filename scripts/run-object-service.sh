#!/usr/bin/env bash
# Build the isolated-components Object Manager service (client + server as two
# separate seL4 components talking over SURT) + the kernel, and boot it in QEMU.
#
...
./components/object-service/build.sh
